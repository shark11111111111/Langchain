...
class Feedback(BaseModel):
    ...
    sentiment: Literal['url','question']=Field(description="classify following as url or question")

parser1=PydanticOutputParser(pydantic_object=Feedback)

prompt=PromptTemplate(
    template="Classify the sentiment of the following question {question} into url or question \n {format_instruction}",
